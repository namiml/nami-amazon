...
Nami is on a mission to help you grow your Fire TV app revenue from IAPs and subscriptions.
Go beyond basic Amazon Appstore IAP infrastructure and focus on results with:
...
dependencies {
  implementation "com.namiml:sdk-amazon:3.0.5"
}
...
Once the SDK is initialized, you're ready to show a paywall. See the [complete guide to setting up Nami for Amazon Appstore](https://docs.namiml.com/docs/amazon-appstore-android-setup) to find out how.
